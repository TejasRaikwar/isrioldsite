<?php if (!defined('IPHORM_VERSION')) exit; ?><div class="wrap">
    ...
    <form method="post" action="">
        ...
        <p class="submit iphorm-save-settings"><input type="submit" value="<?php esc_attr_e('Save Changes', 'iphorm'); ?>" class="button-primary" name="iphorm_settings" /></p> W - P - L - O - C - K - E - R - . - C - O - M
    </form>
</div>
